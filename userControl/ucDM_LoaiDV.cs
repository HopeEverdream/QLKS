...
{
    public partial class ucDM_LoaiDV : UserControl
    {
        public ucDM_LoaiDV()
        {
            InitializeComponent();
        ...
        #region Connect UC
        public static ucDM_LoaiDV _instrance;
        public static ucDM_LoaiDV Instrance
        {

            get
            {
                if (_instrance == null)
                    _instrance = new ucDM_LoaiDV();
                return _instrance;
            }
        }
        #endregion
        ...
        public static string ConnectionString = @"Data Source=littlefish\KAFKA;Initial Catalog=QL_KHACHSAN;Integrated Security=True";
        SqlConnection conn;
        ...
        public void LoadGrd()
        {
            ...
            string query = "SELECT * FROM DM_LOAIDV WHERE TRANG_THAI = '1'  ";
            ...
            {
                grdLoaiDV.DataSource = ds.Tables[0];
            }
            else
            {
                grdLoaiDV.DataSource = null;
        ...
        public void BindingData()
        {
            ...
            txtMaLoaiDV.DataBindings.Add(new Binding("Text", ds.Tables[0], "MA_LOAI_DV", false, DataSourceUpdateMode.Never));
            txtTenLoaiDV.DataBindings.Add(new Binding("Text", ds.Tables[0], "TEN_LOAI_DV", false, DataSourceUpdateMode.Never));
        ...
        public void InsertData()
        {
            try
            {
                if (txtMaLoaiDV.Text.Trim() == "")
                {
                    lblThongBao.Text = "Nhập vào mã loại dịch vụ";
                    txtMaLoaiDV.Focus();
                }
                else if (txtTenLoaiDV.Text.Trim() == "")
                {
                    lblThongBao.Text = "Nhập vào tên loại dịch vụ";
                    txtTenLoaiDV.Focus();
                }
                else
                {
                    ...
                    if (txtDuongDanAnh.Text != null && txtDuongDanAnh.Text.Trim() != "")
                    {
                        string sqlInsert = "INSERT_DM_LOAIDV";
                        SqlCommand cmd = new SqlCommand(sqlInsert, conn);
                        cmd.Parameters.AddWithValue("@MA_LOAI_DV", txtMaLoaiDV.Text.Trim());
                        cmd.Parameters.AddWithValue("@TEN_LOAI_DV", txtTenLoaiDV.Text.Trim());
        ...
        public bool CheckExits(String MA_LOAI_DV)
        {
            try
            {
                conn = new SqlConnection(ConnectionString);
                ...
                string sqlCheck = "CHECK_EXITS_LOAIDV";
                SqlCommand cmd = new SqlCommand(sqlCheck, conn);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@MA_LOAI_DV", MA_LOAI_DV);
        ...
        public void UpdateData()
        {
            try
            {
                ...
                {
                    LoadImg();
                    string sqlUpdate = "UPADTE_DM_LOAIDV";
        ...
        public void DeleteData()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        string sqlDelete = "DELETE_DM_LOAIDV";
        ...
        public void SearchData()
        {
            try
            {
                ...
                string sqlSearch = "SEARCH_DM_LOAIDV";
        ...
        public void ExportExcel(DataTable tb, string sheetname)
        {
            ...
            head.Value2 = "DANH SÁCH LOẠI DỊCH VỤ CỦA KHÁCH SẠN";
            head.Font.Bold = true;
            ...
            cl1.Value2 = "MÃ LOẠI DV";
            cl1.ColumnWidth = 15.0;
            Microsoft.Office.Interop.Excel.Range cl2 = oSheet.get_Range("B3", "B3");
            cl2.Value2 = "TÊN LOẠI DV";
        ...
        private void btnGhi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                bool cExits = false;
                cExits = CheckExits(txtMaLoaiDV.Text.Trim());
                if (cExits == false)
                {
                    lblThongBao.Text = "Đã tồn tại mã loại dịch vụ: " + txtMaLoaiDV.Text.Trim() + " trong hệ thống";
                    return;
                }
                InsertData();
            }
        ...
        private void btnXuatExcel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            string sqlSearch = "EXCEL_DM_LOAIDV";
            SqlCommand cmd = new SqlCommand(sqlSearch, conn);
            ...
            cmd.Dispose();
            con.Close();
            ExportExcel(tb, "DS Loại dịch vụ khách sạn");
        }
